...
```{r}
expanded_clones(rna_tcr, sample.1 = "3354_T1")
```
...
```{r}
expanded_clones(rna_tcr, sample.1 = c("3354_T1","3354_T2","3354_T3","3354_T4","3354_T5","3354_T6"))
```
...
```{r}
top_10_th2 <- expanded_th2$CTaa[1:50]
